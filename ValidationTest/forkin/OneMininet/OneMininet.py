...
def perfTest(  ):
    ...
    c4 = net.addController('c4', ip='192.168.33.101', port=6333)

    net.start()
    h1, h2, h3, h4 = net.getNodeByName('h1', 'h2', 'h3','h4')
    #h1.cmd("./Server 1-2v2 10001 &")
    #h1.cmd("./Server 1-3v2 10002 &")
    #h1.cmd("./Server 1-4v2 10003 &")
    #h2.cmd("./Client 2-1v2 12.0.2.1 10001&")
    #h3.cmd("./Client 3-1v2 12.0.2.1 10002&")
    #h4.cmd("./Client 4-1v2 12.0.2.1 10003")
    CLI(net)
    net.stop()
