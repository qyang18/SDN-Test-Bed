...
s1 = net.addSwitch('s1',dpid='1000000000000031')
s2 = net.addSwitch('s2',dpid='1000000000000032')

info("*** Creating hosts\n")
h1 = net.addHost('h1',ip='12.0.3.1')
h2 = net.addHost('h2',ip='12.0.3.2')
h3 = net.addHost('h3',ip='12.0.3.3')
h4 = net.addHost('h4',ip='12.0.3.4')
h5 = net.addHost('h5',ip='12.0.3.5')
h6 = net.addHost('h6',ip='12.0.3.6')
h7 = net.addHost('h7',ip='12.0.3.7')
h8 = net.addHost('h8',ip='12.0.3.8')
